...
const LandingPageTrackCard = () => {
  return (
    <div className="bg-[#FFFFFF] flex flex-col sm:flex-row text-center sm:text-left text-[18px] md:text-[20px] lg:text-[24px] font-[700] text-[#785DBA] justify-between px-4 sm:px-6 md:px-10 w-full max-w-[850px] rounded-[8px] h-[104px] shadow-sm">
