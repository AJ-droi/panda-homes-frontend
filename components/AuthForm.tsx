      ...
      <form className="space-y-4 mt-6 text-[#666666]">
        ...
        {!isLogin && (
            <div className='flex gap-2 mt-10 items-start justify-items-start'>
                ...
                <div className='text-base text-[#333333]'>By creating an account, you agree to our <span><Link href='#' className='underline'>Terms of use</Link></span> and <span><Link href='#' className='underline'>Privacy Policy</Link></span></div>
            </div>
        )}
