  ...
  return (
    <div className="w-full relative">
      ...
      >
        {/* Country Selector */}
        <div
          className="flex items-center bg-[white] px-1 py-3.5 border-r border-[#E0E0E0] cursor-pointer"
          onClick={() => {
        ...
        >
          ...
          <span className="text-sm text-[14px] text-[#999999] mr-1">
        ...
        {/* Phone Input */}
        <input
          className="flex-1 px-3 py-3.5 text-[14px] text-[#999999] bg-[white] focus:outline-none"
          value={phoneNumber}
